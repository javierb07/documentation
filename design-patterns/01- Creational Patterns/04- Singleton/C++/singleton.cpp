...
The getInstance() method is used to access the static instance. This way we ensure that only one
instance of the class is created.
This is just a simple example. Production code should include a destructor to release resources, 
provide thread safety, etc.
*/
#include <iostream>
using namespace std;
